...
// int bullshit(int fucker);

// int temperature_node(ThermApp *thermapp, short *ImgData)
// extern void temperature_publish_function(short value[PIXELS_DATA_SIZE]);
// extern void start_temperature_node();
// extern int tester(int input);
// extern int publish_temperature_f();
